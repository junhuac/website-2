...
<!-- Announcement Aside Popup -->
<aside class="popup announcement" data-persistent="true">
	<div class="container">
		<div>
			<p>We have concluded a successful ICO pre sale which ran from 22nd November to the 15th December. During this time we secured investment in excess of $1.7Million USD, largely from within the industry.<br>These transactions will be added to the total token sales once the bonus stages are complete.</p>
			<p>Adriaan Brink,
			<br>CEO</p>
		</div>
	</div>
